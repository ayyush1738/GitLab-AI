...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold uppercase tracking-widest transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.96] select-none",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-slate-800 bg-slate-950/50 backdrop-blur-sm text-slate-300 hover:bg-slate-900 hover:text-white hover:border-slate-700",
        secondary:
        ...
        link: 
          "text-indigo-400 underline-offset-4 hover:underline lowercase font-mono",
        // 🛡️ The "Grand Prize" Safety Variant
        safety: 
          "bg-emerald-600/90 text-white shadow-lg shadow-emerald-500/20 hover:bg-emerald-500 backdrop-blur-md border border-emerald-400/20",
      },
      size: {
